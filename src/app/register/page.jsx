...
const Register= () => {
  ...
  <div className="flex flex-col w-full max-w-sm mt-6">
    <label htmlFor="" className=' text-sm mb-2 font-semibold'>Already have an account? Login</label>
    <Link href={"/login"} className='text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 text-center'>Login</Link>
  </div>
    </div>
  )
}
